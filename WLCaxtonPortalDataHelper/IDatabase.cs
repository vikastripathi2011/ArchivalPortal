...
// Program Description  : This is a Database Interface. It defines all the definations of data related operations.
...
namespace WLCaxtonPortalDataHelper
{
    public interface IDatabase
    {
        ...
        DbCommand CreateCommand(string Proc);

        DbCommand CreateSqlQuery(string query);

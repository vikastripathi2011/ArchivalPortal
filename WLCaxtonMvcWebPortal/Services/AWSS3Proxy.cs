...
namespace WLCaxtonMvcWebPortal.AWSS3ServiceReference
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName = "AWSS3ServiceReference.IAWSS3FileTransfer")]
    public interface IAWSS3FileTransfer
    {
        ...
        System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Bucket> GetBucketList(string Username, string client, string bucketname);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IAWSS3FileTransfer/GetBucketList", ReplyAction = "http://tempuri.org/IAWSS3FileTransfer/GetBucketListResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Bucket>> GetBucketListAsync(string Username, string client, string bucketname);
        ...
        System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Key> ListingObjects(string Username, string client, string bucketName, string fileName);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IAWSS3FileTransfer/ListingObjects", ReplyAction = "http://tempuri.org/IAWSS3FileTransfer/ListingObjectsResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Key>> ListingObjectsAsync(string Username, string client, string bucketName, string fileName);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAWSS3FileTransferChannel : WLCaxtonMvcWebPortal.AWSS3ServiceReference.IAWSS3FileTransfer, System.ServiceModel.IClientChannel
    {
    }

    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AWSS3FileTransferClient : System.ServiceModel.ClientBase<WLCaxtonMvcWebPortal.AWSS3ServiceReference.IAWSS3FileTransfer>, WLCaxtonMvcWebPortal.AWSS3ServiceReference.IAWSS3FileTransfer
    {
        ...
        public System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Bucket> GetBucketList(string Username, string client, string bucketname)
        {
            return base.Channel.GetBucketList(Username, client, bucketname);
        }

        public System.Threading.Tasks.Task<System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Bucket>> GetBucketListAsync(string Username, string client, string bucketname)
        {
        ...
        public System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Key> ListingObjects(string Username, string client, string bucketName, string fileName)
        {
            return base.Channel.ListingObjects(Username, client, bucketName, fileName);
        }

        public System.Threading.Tasks.Task<System.Collections.Generic.List<WLCaxtonMvcWebPortal.AWSS3ServiceReference.Key>> ListingObjectsAsync(string Username, string client, string bucketName, string fileName)
        {
